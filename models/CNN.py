...
class CNNModule(nn.Module, ABC):
    def __init__(self, input_dimensions, input_length, output_classes):
        ...
        self.conv3 = nn.Conv2d(64, 64, kernel_size=(1, 3), stride=1, padding=1)
        self.pool3 = nn.MaxPool2d(2, 2)
        self.conv4 = nn.Conv2d(64, 64, kernel_size=(1, 3), stride=1, padding=1)
        self.pool4 = nn.MaxPool2d(2, 2)
        # TODO 64 * 1 * 1 需要改成相对应的输出
        self.fc1 = nn.Linear(64 * 13 * 48, 1024)
